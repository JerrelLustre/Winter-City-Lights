...
<body class="bg-gold-light w-screen">
    ...
    <!-- End:Header -->
        ...
        <!-- Banner Container -->
            <section class="bg-[url('../img/homepageBanner-winter-city-lights.jpg')] mb-[12.1875rem] bg-cover bg-center bg-no-repeat border-t-4 border-b-4 box-border border-navy flex flex-col items-center justify-center w-screen">
            ...
            <section class="max-w-[98.75rem] mx-auto flex justify-center flex-col mb-16">
                ...
                <div class="flex flex-wrap justify-center mx-auto mb-8">
                        <div class="relative -z-10 basis-1/2 md:basis-1/3 max-w-[37.5rem] min-w-[10rem] max-h-[37.5rem]">
                            <img class="JSlazyload object-cover w-full h-full" src="<?php echo get_public_url('img/lazyload/loading-familyCelebration2019-gallery-img-winter-city-lights.jpg') ?>" data-src="<?php echo get_public_url('img/familyCelebration2019-gallery-img-winter-city-lights.jpg') ?>" alt="A family having fun out in the snow">
                        ...
                        <div class="relative -z-10 basis-1/2 md:basis-1/3 max-w-[37.5rem] min-w-[10rem]  max-h-[37.5rem]">
                            <img class="JSlazyload object-cover w-full h-full" src="<?php echo get_public_url('img/lazyload/loading-winterBazaar2018-gallery-img-winter-city-lights.jpg') ?>" data-src="<?php echo get_public_url('img/winterBazaar2018-gallery-img-winter-city-lights.jpg') ?>" alt="A light structure in the shape of a snowflake with light adorned trees in the background">
                            <div class="bottom-4 left-4 md:text-base drop-shadow-txt absolute z-10 font-medium text-white">
                                <p>2019 Winter City Lights</p>
                        ...
                        <div class="relative -z-10 basis-1/2 md:basis-1/3 max-w-[37.5rem] min-w-[10rem]  max-h-[37.5rem]">
                            <img class="JSlazyload object-cover w-full h-full" src="<?php echo get_public_url('img/lazyload/loading-iceSculptures2019-gallery-img-winter-city-lights.jpg') ?>" data-src="<?php echo get_public_url('img/iceSculptures2019-gallery-img-winter-city-lights.jpg') ?>" alt="">
                            <div class="bottom-4 left-4 md:text-base drop-shadow-txt absolute z-10 font-medium text-white">
                                <p>2019 Winter City Lights</p>
                        ...
                        <div class="relative -z-10 basis-1/2 md:basis-1/3 max-w-[37.5rem] min-w-[10rem]  max-h-[37.5rem]">
                            <img class="JSlazyload object-cover w-full h-full" src="<?php echo get_public_url('img/lazyload/loading-winterBazaar2022-gallery-img-winter-city-lights.jpg') ?>" data-src="<?php echo get_public_url('img/winterBazaar2022-gallery-img-winter-city-lights.jpg') ?>" alt="">
                            <div class="bottom-4 left-4 md:text-base drop-shadow-txt absolute z-10 font-medium text-white">
                        ...
                        <div class="relative -z-10 basis-1/2 md:basis-1/3 max-w-[37.5rem] min-w-[10rem]  max-h-[37.5rem]">
                            <img class="JSlazyload object-cover w-full h-full" src="<?php echo get_public_url('img/lazyload/loading-lightSculptures2018-gallery-img-winter-city-lights.jpg') ?>" data-src="<?php echo get_public_url('img/lightSculptures2018-gallery-img-winter-city-lights.jpg') ?>" alt="">
                            <div class="bottom-4 left-4 md:text-base drop-shadow-txt absolute z-10 font-medium text-white">
