...
$title = "Winter City Lights - Vancouver Winter Festival Ticket Purchase";
...
<body class="bg-gold-light">
    ...
    <main class=" relative mb-16 md:mb-0">
        ...
        <!-- Page heading -->
        <div class="text-navy max-w-md mx-auto py-20 text-center">
            <h1 class="font-serif text-5xl mb-4">Ticket Purchase</h1>
            <p class="font-sans text-2xl w-4/5 mx-auto">Create New Memories This Winter</p>
        </div>
        <!-- End: page heading -->
        ...
        <div class="flex  items-center relative  justify-center gap-12 flex-wrap">
            ...
            <div class="text-white text-base max-w-md ">
                ...
                tracking-widest relative top-4 px-5 w-fit py-[0.625rem] border-gold bg-gold-light border-4 font-serif text-navy rounded-3xl text-3xl text-center shadow-blue ">Family Pass</h2>
                <div class="bg-navy mx-2 p-4 rounded-3xl py-12">
                    ...
                    <p class="mb-10">Tickets are general admission and grant access to the Festival Site for the entire event duration</p>
            ...
            <!-- Card 2 -->
            <div class="text-white text-base max-w-md  ">
                <h2 class="tracking-widest relative top-4 px-5 w-fit py-[10px] border-gold bg-gold-light border-4 font-serif text-navy rounded-3xl text-3xl text-center shadow-blue ">Family Pass</h2>
                <div class="bg-navy mx-2 p-4 rounded-3xl py-12">
       ...
       <!-- End: Cards Container -->
       <div class="flex justify-end fixed md:static bottom-0 lg:mt-12" >
            <div class="w-screen py-4 bg-gold-light border-4 border-navy rounded-bl-3xl rounded-tl-3xl flex  justify-center items-center sm:w-fit">
                    <a class="btn mx-8" href="#">Checkout Items</a>
