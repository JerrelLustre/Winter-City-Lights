<header class="bg-navy z-50 sticky top-0">
    <div class="max-w-[68rem] mx-auto  flex justify-between items-center py-2">
        <div class="w-full lg:w-fit flex justify-between items-center mx-8">
            <a class="w-[11.5625rem] block font-serif text-2xl font-bold uppercase text-gold-light " href="#"><img class="w-full h-auto" src="./img/logo-wintercitylights.svg" alt="Winter City Lights Logo"></a>
        ...
        <nav id="menu" class="-translate-y-full lg:mx-8 lg:-translate-y-0 transition-transform bottom-0 top-0 right-0 left-0 fixed bg-navy lg:h-auto lg:static box-sizing ">
            <ul class="flex h-full flex-col lg:flex-row items-center justify-between lg:gap-4  lg:py-4  pt-28 lg:mt-0" >
                <li class="w-3/5 mx-auto"><a class="<?php if($title == "Winter City Lights - Vancouver Winter Festival Homepage"){echo("pointer-events-none text-gold");} else {echo("text-gold-fade hover:underline hover:text-gold-light");} ?> font-serif py-8 border-gold pl-4 border-4 lg:border-0  text-6xl w-full block lg:inline lg:text-2xl font-bold uppercase lg:py-2 lg:px-8 rounded transition-all" href="index.php">Home</a></li>
                <li class="w-3/5 mx-auto"><a class="<?php if($title == "Winter City Lights - Vancouver Winter Festival Ticket Purchase"){echo("pointer-events-none text-gold");} else {echo("text-gold-fade hover:underline hover:text-gold-light");} ?> font-serif py-8 border-gold pl-4 border-4 lg:border-0  text-6xl w-full block lg:inline lg:text-2xl font-bold uppercase lg:py-2 lg:px-8 rounded transition-all" href="buyTickets-winter-city-lights.php">Tickets</a></li>
