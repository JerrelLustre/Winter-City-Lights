...
$snowglobe = new cell([
    ...
    "image" => "snowglobeDesign-winter-city-lights.webp",
    "placeholder" => "loading-snowglobeDesign-winter-city-lights.webp",
...
$multicultral = new cell([
    ...
    "image" => "multicultural-winter-city-lights.webp",
    "placeholder" => "loading-multicultural-winter-city-lights.webp",
...
$events = new cell([
    ...
    "image" => "events-winter-city-lights.webp",
    "placeholder" => "loading-events-winter-city-lights.webp",
...
$merchandise = new cell([
    ...
    "image" => "merchandise-winter-city-lights.webp",
    "placeholder" => "loading-merchandise-winter-city-lights.webp",
